...
<h1>Interpretext Generator</h1>
    <div>Pick a passage, then choose words in the passage to replace & their replacements. Convey the sense of Scripture that may come across better in another language, or in another transaltion!</div>
    ...
    <table style="margin: 50px auto;">
        ...
        <table id='swap-tbl' style="margin: 50px auto; border: 1px solid">
            <th>Word Substitutions</th>  <!--TODO: FIX-->
            <tr> 
                <th>Original</th>
                <th>Replacement</th>
                <tr>
            ...
            <button id='swap-btn' style='text-align: center;'>Re-word Now!</button>
