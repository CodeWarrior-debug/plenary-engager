...
// API Key to use = 016b11d5817b02cc37b96070428b0525
  ...
  const booksArray = require("../../assets/books_w_chapters.json");
    ...
    const getVerses =(bookLabel, chapterStart, startVerse, chosen_translation) => {  // endChap, endVerse
      axios
        .get(`https://bible-api.com/${bookLabel}+${chapterStart}:${startVerse}?translation=${chosen_translation}`)
        .then((res) => {
    ...
    return (
      ...
      <button
         onClick={getVerses(bookLabel, chapterStart,startVerse,chosen_translation)}
        // onClick={getChapters}
        id="import-btn"
